...
X_train = torch.zeros(400, 17, NUM_FRAMES_MAX, NUM_PERS_MAX, COORD_2D, dtype=torch.float32)
print(X_train.dtype)

#y_train = torch.zeros(40000)
#X_test = torch.zeros(16000, 17, NUM_FRAMES_MAX, NUM_PERS_MAX, COORD_2D)
#y_test = torch.zeros(16000)

#X_train = torch.zeros(40000, 3, 17, 112, 112)
...
print('Hello world!')
TestModelDlav = C3D()
print(summary(C3D(), input_size=(5, 17, NUM_FRAMES_MAX, NUM_PERS_MAX, COORD_2D)))
